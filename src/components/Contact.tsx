    ...
    <div id="contact" className="container mx-auto px-4 py-32">
      ...
      <form className="max-w-xl mx-auto">
        ...
        <div className="mb-4">
          ...
          <textarea id="message" name="message" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" rows={5}></textarea>
        </div>
